...
This file contains all project configurations: installed apps, database, middleware, etc.
Django 项目总配置文件，包含应用注册、数据库配置、中间件等所有全局设置。
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # 直接写路径，不用变量
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
